    ...
    agents: [
      {
        ...
        tasks: [
          ...
          "Finale Kauf/Verkauf-Empfehlung mit Überzeugungswert 1–10",
      ...
      },
      {
        ...
        color: "#8b5cf6",
        description:
          "Nina liest täglich aktuelle Schlagzeilen aus Google News und bewertet die Nachrichtenstimmung. Sie erkennt ob die Marktstimmung positiv, neutral oder negativ ist.",
        tasks: [
      ...
      },
      {
        ...
        color: "#ef4444",
        description:
          "Vera prüft Opus' Analyse kritisch gegen die verfügbaren Rohdaten und korrigiert Aussagen die nicht durch echte Daten belegt sind. Sie verhindert Halluzinationen.",
        tasks: [
    ...
    agents: [
      {
        ...
        color: "#f59e0b",
        description:
          "Finn scannt täglich Yahoo Finance Trending Tickers und kombiniert sie mit deinen Watchlist-Aktien. Er bewertet alle Kandidaten anhand ihrer Scores und kürt den Hot Pick des Tages.",
        tasks: [
          "Yahoo Finance Trending Tickers auswerten",
      ...
      },
      {
        ...
        color: "#06b6d4",
        description:
          "Lisa kuratiert den Nachrichten-Feed. Sie liest Schlagzeilen aller Watchlist-Aktien, bewertet ihre Bedeutung für Investoren und übersetzt sie automatisch ins Deutsche.",
        tasks: [
