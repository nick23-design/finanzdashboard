...
const CATEGORIES: Category[] = [
  {
    ...
    agents: [
      ...
      },
      {
        ...
        color: "#ef4444",
        description:
          "Vera prüft Opus' Analyse gegen authoritative Finance-API-Daten, Analysten-Konsens und Artikel-Aktualität. Bei strittigen Behauptungen kann sie bis zu 3 Artikel aus der News-Whitelist nachladen. Korrekturen und Conviction-Anpassungen sind im Analyse-Protokoll sichtbar.",
        tasks: [
          "Authoritative Kennzahlen (Kurs, MAs, RSI, KGV etc.) als Referenz",
          "Altersbasierte Artikel-Freshness-Regeln (Preise <2d, Quartale <14d)",
          "Bis zu 3 Artikel nachladen (fetch_article, Whitelist)",
