    ...
    content: (
      <div className="space-y-3">
        ...
        <Block label="KI-Vollanalyse (Multi-Agenten-Pipeline)">
          ...
          <p>• <strong className="text-white">Marco (Haiku 4.5):</strong> Analysiert Insider-Transaktionen (SEC Form 4), institutionelle Positionen und öffentliches Interesse (Wikipedia-Aufrufe) als Marktsignale.</p>
