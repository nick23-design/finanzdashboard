...
const AGENTS: AgentDoc[] = [
  ...
  },
  {
    ...
    workflow: [
      ...
      "Kai (Sonnet) gibt strukturierte Analyse mit klarem Gewinner zurück",
    ],
    strengths: [
      "Sonnet liefert deutlich differenziertere Vergleiche als der frühere Haiku-Einsatz",
      "Strukturierter Vergleich mit klarem Gewinner ist leicht interpretierbar",
      "Fallback auf Frontend-Daten macht Kai robust bei fehlenden DB-Snapshots",
    ],
    weaknesses: [
      "Kein Peer- oder Branchen-Kontext — vergleicht nur die zwei gewählten Aktien miteinander",
      "Kein Extended Thinking — bei sehr knappen Entscheidungen können Abwägungen oberflächlich sein",
      "Keine aktuellen News oder Sentiment-Daten im Vergleich — nur Kennzahlen",
      "Vergleich ist nur so stark wie die verfügbaren Snapshot-Daten — fehlen Kennzahlen bei einer Aktie, leidet das Urteil",
    ],
    reliability: 4,
    reliabilityNote: "Upgrade auf Sonnet macht Vergleiche deutlich belastbarer. Für tiefste Analysen weiterhin Vollanalyse beider Aktien empfehlenswert.",
  },
  {
    id: "us-scout",
    model: "Claude Haiku",
