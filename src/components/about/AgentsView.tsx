...
const AGENTS: AgentDoc[] = [
  ...
  },
  {
    ...
    inputs: [
      ...
      "Aktuelle News mit Jina-Excerpts (bis zu 10 Artikel mit echtem Artikelinhalt)",
    ],
    outputs: [
      ...
      "Protokoll-Eintrag: sichtbar in der Analyse-Ansicht",
    ],
    systemPrompt: `"Du bist ein kritischer Fact-Checker für Finanzanalysen. Korrigiere nur was durch die gelieferten Daten nachweislich falsch ist. Antworte ausschließlich mit validem JSON."`,
    workflow: [
      "Opus schließt Analyse mit complete_analysis-Tool-Call ab",
      "Vera läuft immer — auch im erfolgreichen Hauptpfad (nicht nur im Fallback)",
      "Vera prüft Faktenbehauptungen gegen Analysten-Daten und Jina-Artikel-Excerpts",
      "Bei nachweislichen Fehlern: Conviction senken + Summary/Bull-/Bear-Case korrigieren",
      "Vera-Ergebnis wird ins Analyse-Protokoll geschrieben und ist für den User einsehbar",
    ],
    strengths: [
      "Läuft jetzt immer — nicht mehr nur im Fallback-Pfad",
      "Jina-Excerpts erlauben echte Inhalts-Prüfung statt nur Headline-Vergleich",
      "Korrigiert unbelegte Bull-/Bear-Case-Punkte direkt statt nur Conviction zu senken",
      "Protokoll macht Vera-Korrekturen für den User transparent sichtbar",
    ],
    weaknesses: [
      "Vera kann nur prüfen was in den übergebenen Daten steht — keine externe Recherche (noch)",
      ...
      "Wenn Opus und Vera denselben Fehler machen, bleibt er unentdeckt",
    ],
    reliability: 4,
    reliabilityNote: "Deutlich stärker: läuft immer, prüft mit echtem Artikelinhalt, korrigiert Inhalte. Externe Recherche (Punkt 4) folgt als nächster Schritt.",
  },
  {
    id: "opus",
