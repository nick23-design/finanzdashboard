...
const AGENTS: AgentDoc[] = [
  ...
  },
  {
    ...
    workflow: [
      ...
      "Vera prüft Faktenbehauptungen gegen Analysten-Daten und Jina-Excerpts",
    ...
    strengths: [
      ...
      "Läuft immer — nicht mehr nur im Fallback-Pfad",
      "Korrigiert unbelegte Bull-/Bear-Case-Punkte direkt statt nur Conviction zu senken",
      "Protokoll macht Vera-Korrekturen inkl. nachrecherchierter Artikel für den User sichtbar",
    ],
    weaknesses: [
