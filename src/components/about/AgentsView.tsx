...
const AGENTS: AgentDoc[] = [
  ...
  },
  {
    ...
    weaknesses: [
      "Langsamster Agent im System (~20–35s) durch Opus + Jina-Fetches für zwei Symbole",
    ...
    reliability: 5,
    reliabilityNote: "Stärkste Vergleichsanalyse im System. Jetzt mit echtem Artikelinhalt für beide Symbole. Hauptkompromiss: längste Wartezeit.",
  },
  {
    id: "us-scout",
    model: "Claude Haiku",
