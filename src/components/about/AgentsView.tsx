...
const AGENTS: AgentDoc[] = [
  ...
  },
  {
    ...
    inputs: [
      ...
      "Bis zu 5 News mit gekürzten Jina-Excerpts — jeder Artikel mit Altersangabe '(vor X Tagen)'",
    ],
    outputs: [
    ...
    weaknesses: [
      ...
      "Der stabile Hauptpfad liest keine vollständigen Artikel nach — kurze Excerpts können für harte Faktchecks zu knapp sein",
      "Der nachgelagerte Check hat ein hartes Timeout und kann übersprungen werden",
      "Altersregeln sind Prompt-Instruktionen — Vera kann sie als KI-Modell nicht garantiert einhalten",
    ],
    reliability: 4,
    reliabilityNote: "Autoritative Snapshot-Daten + Freshness-Regeln reduzieren Falschkorrekturen. Die Hauptanalyse ist stabiler, weil Vera sie nicht mehr blockiert; reliability 5 erst mit separater Queue, längerer Review-Laufzeit oder harter Claim-Validation.",
  },
  {
    id: "opus",
    ...
    trigger: "Teil der Vollanalyse-Pipeline (on-demand)",
    cache: "6 Stunden (als Teil des Gesamtergebnisses)",
    pipeline: "Schritt 4 von 5 — finale Synthese",
    inputs: [
    ...
    outputs: [
      ...
      "Bear-Case (Array, 2–3 Punkte)",
      "Wachstumsausblick (Text)",
      "Bewertungsspanne (eigenes Modell, Bear/Base/Bull) + prüfbare Claims",
    ...
    workflow: [
      ...
      "Bei Opus-Timeout übernimmt ein Haiku-Fallback (runSynthesisFastAgent, ~6–10 s)",
      "Danach laufen die regelbasierten Guardrails; Vera prüft im Nachgang und aktualisiert Protokoll/Status",
    ],
    strengths: [
    ...
    weaknesses: [
      ...
      "Kursziele und Spannen sind Modell-Schätzungen, keine professionellen Analystenpreise",
