...
export const MODEL_REGISTRY: AnalysisModelRegistryEntry[] = [
  ...
  // ─── Sector-specific planned models ─────────────────────────────────────────
  {
    ...
    requiredInputs: ["cet1", "nim", "rotce", "ptbv", "loan_losses"],
    optionalInputs: ["efficiency_ratio", "net_income", "total_debt"],
  ...
  },
  {
    ...
    optionalInputs: ["occupancy", "same_store_noi", "cap_rates", "net_debt"],
    outputKind: "sector_specific",
  ...
  },
  {
    ...
    requiredInputs: ["oil_price", "gas_price", "production_volume"],
    optionalInputs: ["reserves", "commodity_scenarios", "net_debt", "capex"],
    outputKind: "sector_specific",
  ...
  },
  {
    ...
    requiredInputs: ["arr", "revenue_growth"],
    optionalInputs: ["nrr", "sbc", "fcf_margin", "rule_of_40"],
    outputKind: "sector_specific",
  ...
  },
  {
    ...
    requiredInputs: ["revenue", "gross_margin", "revenue_growth"],
    optionalInputs: ["capex", "working_capital"],
    outputKind: "sector_specific",
  ...
  },
  {
    ...
    applicableCompanyTypes: ["cyclical_hardware"],
    notApplicableCompanyTypes: ALL_TYPES.filter(t => t !== "cyclical_hardware"),
    requiredInputs: ["revenue", "gross_margin", "operating_margin", "working_capital"],
  ...
  },
  {
    ...
    requiredInputs: ["segments", "segment_revenue", "segment_operating_income"],
    optionalInputs: ["revenue", "market_cap"],
    outputKind: "sector_specific",
